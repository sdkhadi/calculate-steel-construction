...
tree.heading('r_lentur', text='Rasio Lentur', anchor=CENTER)
tree.heading('r_geser', text='Rasio Geser', anchor=CENTER)
tree.heading('r_stabilitas_tekuk', text='Stabilitas Penampang Flenge', anchor=CENTER)
tree.heading('r_stabilitas_penampang_flenge', text='Stabilitas Penampang Web', anchor=CENTER)
tree.heading('r_stabilitas_penampang_web', text='Ratio Stabilitas Tekuk', anchor=CENTER)
...
tree.column('#4', width=55, stretch=NO,anchor=CENTER)
tree.column('#5', width=55, stretch=NO,anchor=CENTER)
...
tree.column('#10', width=130, stretch=NO,anchor=CENTER)
